...
def main(
    ...
    if model == "llama2":
        ...
        base_model_dir,tokenizer_dir = "./llama2/LlamaForCausalLM","./llama2/tokenizer"
        if os.path.exists(base_model_dir) and os.path.exists(tokenizer_dir):
            ...
            tokenizer = AutoTokenizer.from_pretrained("./llama2/tokenizer")
        ...
        base_model_dir,tokenizer_dir = "./mistral/model","./mistral/tokenizer" #TODO update /mistral/model once i have it downloaded
        if os.path.exists(base_model_dir) and os.path.exists(tokenizer_dir):
...
if __name__ == "__main__":
    ...
    main(args.model, prompt, args.max_length, args.batch_size, float(args.learning_rate), args.epochs)