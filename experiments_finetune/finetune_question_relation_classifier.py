...
from prompts import *
from models.QuestionRelationDataLoader import *
...
def main(
    ...
    if model_type == "llama2":
        ...
        dataloader = QuestionRelationDataLoader(tokenizer, prompt_fn, max_length)
    ...
    if size != 0: 
        ...
        if model_type == "llama2": model.save_pretrained(f"./models/llama2/LlamaQuestionRelationClassifier_{size}")
        if model_type == "mistral": model.save_pretrained(f"./models/mistral/MistralQuestionRelationClassifier_{size}")
