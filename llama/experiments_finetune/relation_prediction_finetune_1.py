...
def test_llama(model, tokenizer, test_dataset, max_length):
    print("\ntesting")
...
def main(
    ...
    # Load data
    print("\nloading data")
    dataloader = DataLoader(tokenizer, prompt_fn, max_length)
    ...
    # Test
    test_llama(model, tokenizer, dev_dataset, max_length)
